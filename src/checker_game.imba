# change to <script type="module" src="./src/checker_game.imba"></script> in index.html to run this code   

global css body bg:linear-gradient(135deg,#fce4ec,#e0f7fa) us:none
global css body::-webkit-scrollbar d:none
	...
	def render
		<self>
			<div [pos:absolute top:50% left:50% translate:-50% -50% d:vflex ja:center g:20px]>
				...
				<div .rotate=rotate [p:20px bg:brown rd:12px box-shadow:0 4px 20px rgba(0,0,0,0.2) rotate.rotate:180deg tween:transform .5s]>
