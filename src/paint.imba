# change to <script type="module" src="./src/paint.imba"></script> in index.html to run this code   
		...
		<self>
			...
			pos:absolute left:50% top:50% translate:-50% -50%]>
				<div [mb:10px d:flex g:20px ja:center]>
					...
					<label [d:flex ja:center g:5px]> "{brushMode ? 'Brush' : 'Eraser'} Size: "
