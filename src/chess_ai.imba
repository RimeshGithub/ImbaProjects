# change to <script type="module" src="./src/chess_ai.imba"></script> in index.html to run this code   
			...
			<div [pos:absolute top:50% left:50% translate:-50% -50% d:vflex g:20px ja:center mt:-1%]>
				...
				<div [d:flex g:30px ja:center]>
					...
					<div [
						...
						g:2px bg:brown box-shadow:0 6px 16px rgba(0,0,0,0.25)
					]>
						for row in [0 ... 8]
							for col in [0 ... 8]
