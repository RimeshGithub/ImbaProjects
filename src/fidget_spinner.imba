# change to <script type="module" src="./src/fidget_spinner.imba"></script> in index.html to run this code   
...
tag fidget-spinner
	...
	def render
		<self [d:flex jc:center ai:center h:100vh bg:radial-gradient(circle, #000, #333)]>
