# change to <script type="module" src="./src/analog_clock.imba"></script> in index.html to run this code   

global css
	body d:flex jc:center ai:center h:100vh bg:#f0f0f0 ff:sans-serif bg:radial-gradient(circle, #fff, #000)
