# change to <script type="module" src="./src/music_player.imba"></script> in index.html to run this code   

import { Howl } from 'howler'

global css body bg:linear-gradient(90deg,#777,#333)
