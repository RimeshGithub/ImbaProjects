# change to <script type="module" src="./src/calendar.imba"></script> in index.html to run this code   

global css body us:none bg:radial-gradient(ellipse, brown, brown5)
global css * ff:monospace box-sizing:border-box
