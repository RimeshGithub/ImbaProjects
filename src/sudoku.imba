# change to <script type="module" src="./src/sudoku.imba"></script> in index.html to run this code   

global css * ff:monospace
global css body bg:radial-gradient(ellipse,brown,brown5)
