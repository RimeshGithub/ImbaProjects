# change to <script type="module" src="./src/chess.imba"></script> in index.html to run this code   

import { Chess } from 'chess.js'

global css body us:none
			...
			<div [pos:absolute top:50% left:50% translate:-50% -50% d:vflex g:12px ai:center]>
				...
				<div [d:flex g:40px ja:center]>
					...
					<div .rotate=rotate [
						...
						g:2px bg:brown box-shadow:0 6px 16px rgba(0,0,0,0.25) tween:transform 0.5s
					]>
						for row in [0...8]
							for col in [0...8]
