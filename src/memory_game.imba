# change to <script type="module" src="./src/memory_game.imba"></script> in index.html to run this code   

import { nanoid } from 'nanoid/non-secure'

global css body bg:linear-gradient(135deg,#e3f2fd,#fce4ec)
css
	.card-container
