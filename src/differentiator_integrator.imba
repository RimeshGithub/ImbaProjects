# change to <script type="module" src="./src/differentiator_integrator.imba"></script> in index.html to run this code   

global css * ff:monospace

import Algebrite from 'algebrite'

tag differentiator-integrator
	prop expression = ""
	prop result = null
...
imba.mount <differentiator-integrator>
